...
<body style="margin:50px;">
	...
	<div class="page-header">
		<h3><strong>维度选择</strong></h3><br/>
	</div>
	<!-- search -->
	<div>
		<form class="form-inline">
			<div class="form-group">
				<label class="control-label" for="limitGroup">维度分组：</label>
				...
				<span>&nbsp;&nbsp;</span>
				<label class="control-label" for="limitName">维度名称：</label>
				<input type="text" class="form-control" id="limitName" placeholder="维度名称"><span>&nbsp;&nbsp;</span>
